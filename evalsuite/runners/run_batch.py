...
def load_records(path: Path, limit: int | None = None) -> Iterator[dict]:
...
def emit_records(records: Iterable[dict], path: Path | None) -> None:
...
def main() -> None:
    ...
    emit_records(evaluated, output_path)
